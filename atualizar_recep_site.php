          ...
          <div class="row">
            ...
            <div class="col-lg-6 mb-4">
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                  <form class="user" method="post" action="atualizar_dados_recep.php">
                    <div class="form-group row">
                      <div class="col-sm-6 mb-3 mb-sm-0">
                        <p> Digite o número do cartão SUS do Paciente que será alterado o cadastro</p>
                        <input type="number" class="form-control form-control-user" name="sus" id="sus" placeholder="Nº SUS" value="" required>                        
                      </div>                          
                    </div>
                    <hr>
                    <div class="form-group row">
                      ...
                      <div class="col-sm-2 mb-3 mb-sm-0">
                        <input type="text" class="form-control form-control-user" name="cep" id="cep" placeholder="CEP" value="" required>
                      </div>
                    </div>                    
                    <div class="form-group row">
                      <div class="col-sm-6 mb-3 mb-sm-0">
                        <input type="text" class="form-control form-control-user" name="tel" id="residencial" placeholder="Tel. Residencial" value="" required> 
                      </div>
                      <div class="col-sm-6 mb-3 mb-sm-0">                          
                        <input type="text" class="form-control form-control-user" name="tel2" id="celular" placeholder="Tel. Celular" value="">                               
                      </div>                            
                    </div>
                    <hr>
                    <div class="form-group row">
                      <div class="col-sm-12 mb-3 mb-sm-0">
                        <input type="email" class="form-control form-control-user" name="email" id="exampleInputEmail" placeholder="Email" value="" required>
                      </div>
                    </div>
                    <div class="form-group row">
                      <div class="col-sm-6 mb-3 mb-sm-0">
                        <input type="password" class="form-control form-control-user" name="senha" id="exampleInputPassword" placeholder="Senha" value="" required>
                      </div>
                      <div class="col-sm-6">
