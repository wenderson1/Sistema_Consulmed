...
if(!isset($_SESSION['UsuarioLog'])){
    ...
    $query = "SELECT * FROM PACIENTE WHERE PACI_NUM_SUS = '$usuario'";
    $atualiza = mysqli_query($dbcon, $query);

    while ($linha = $atualiza->fetch_array()) {
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Dados Usuário</h1>            
          </div>
            ...
            <div class="col-lg-6 mb-4">
              ...
              <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">Atualize seus dados abaixo:</h6>
                </div>
                <div class="card-body">
                    <form class="user" method="post" action="atualiza_dados.php">                      
                        <div class="form-group row">
                          <div class="col-sm-5 mb-3 mb-sm-0">                          
                            <input type="text" class="form-control form-control-user" name="endereco" id="logradouro" placeholder="Endereco" maxlength=100 value="<?php echo $linha['PACI_RUA'];?>" required>
                          </div>                          
                          <div class="col-sm-3 mb-3 mb-sm-0">
                            <input type="text" class="form-control form-control-user" name="bairro" id="logradouro" placeholder="Bairro" maxlength=100 value="<?php echo $linha['PACI_BAIRRO'];?>" required>
                          </div>                          
                          <div class="col-sm-2 mb-3 mb-sm-0">
                            <input type="text" class="form-control form-control-user" name="numero" id="num" placeholder="Número" value="<?php echo $linha['PACI_NUM'];?>" required >
                          </div>
                          <div class="col-sm-2 mb-3 mb-sm-0">
                            <input type="text" class="form-control form-control-user" name="cep" id="cep" placeholder="CEP" value="<?php echo $linha['PACI_CEP'];?>" required>
                          </div>                          
                        </div>
                        <div class="form-group row">
                          <div class="col-sm-6 mb-3 mb-sm-0">
                            <input type="text" class="form-control form-control-user" name="tel" id="residencial" placeholder="Tel. Residencial" value="<?php echo $linha['PACI_TEL'];?>" required> 
                          </div>
                          <div class="col-sm-6 mb-3 mb-sm-0">                          
                            <input type="text" class="form-control form-control-user" name="tel2" id="celular" placeholder="Tel. Celular" value="<?php echo $linha['PACI_TEL2'];?>">                               
                          </div>                            
                        </div>
                        <hr>
                        <div class="form-group row">
                          <div class="col-sm-12 mb-3 mb-sm-0">
                            <input type="email" class="form-control form-control-user" name="email" id="exampleInputEmail" placeholder="Email" value="<?php echo $linha['PACI_EMAIL'];?>" required>
                          </div>
                        </div>
                        <div class="form-group row">
                          <div class="col-sm-6 mb-3 mb-sm-0">
                            <input type="password" class="form-control form-control-user" name="senha" id="exampleInputPassword" placeholder="Senha" value="<?php echo $senha = $linha['PACI_SENHA'];?>" required>
                          </div>
                          <div class="col-sm-6">
                            <input type="password" class="form-control form-control-user" name="confirma_senha" id="exampleRepeatPassword" placeholder="Repita Senha" value="<?php echo $senha = $linha['PACI_SENHA'];?>" required>
                          </div>
                        </div>
