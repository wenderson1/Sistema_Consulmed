      ...
      <div class="col-xl-10 col-lg-12 col-md-9">
        <div class="card o-hidden border-0 shadow-lg my-5">
          <div class="card-body p-0">
            ...
            <!-- Box de Recuperação Senha -->
            <div class="row">
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-2">Esqueceu a senha?</h1>
                    <p class="mb-4">Nós entendemos, isso acontece. Basta digitar suas informações corretamente e iremos mostrar sua senha!</p>
                  </div>
                  <form class="user" method="post" action="esqueceu_senha.php">
                    <div class="form-group">
                      <input type="number" class="form-control form-control-user" id="exampleInputEmail" name="sus" placeholder="Digite seu Nº do SUS...">
                      <br>
                      <input type="number" class="form-control form-control-user" id="exampleInputEmail" name="cpf" placeholder="Digite seu CPF...">
                      <br>
                      <input type="number" class="form-control form-control-user" id="exampleInputEmail" name="rg" placeholder="Digite seu RG...">
                    </div>
                  ...
                  <hr>                  
                  <div class="text-center">
                    <a class="small" href="login_site.php">Já possui uma conta? Conecte-se!</a>
                  </div>
                </div>
              </div>
            </div>
