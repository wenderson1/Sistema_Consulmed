            ...
            <div class="col-lg-6 mb-4">
              ...
              <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h4 class="m-0 font-weight-bold text-primary">Selecione a consulta abaixo:</h4>
                </div>

                <div class="card-body">
                  <form class='user' method='post' action='escolhe_consulta.php'>

                    <?php   

                    $sql = "SELECT * FROM CONSULTA WHERE ESCOLHEU_CONSULTA=0 AND CONFIRMA_CONSULTA=0 AND PACI_NUM_SUS IS NULL AND DT_CONSULTA > SYSDATE() ";
