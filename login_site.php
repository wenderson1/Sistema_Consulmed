              ...
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">Bem-vindo ao <b>ConsulMed</b>!</h1>
                  </div>
                  <!-- Formulário de Login e Senha -->
                  <form class="user" method="post" action="login_cliente.php">
                    <div class="form-group">
                      <input type="number" class="form-control form-control-user" name="sus" id="sus" placeholder="Digite o número do SUS" required>                      
                    </div>
                    <div class="form-group">
                      <input type="password" class="form-control form-control-user" name="senha" id="senha" placeholder="Senha" required>
                    </div>                    
                    <button type="submit" href="index_site.php" class="btn btn-primary btn-user btn-block">
                      Login
                    </button>               
                  </form>
                  ...
                  <hr>
                  <div class="text-center">
                    <a class="small" href="esqueceu_senha_site.php">Esqueceu sua senha?</a>
                  </div>
                  <div class="text-center">
                    <a class="small" href="cadastro_site.php">Não possui uma conta? Cadastre-se!</a>
                  </div>
                </div>
              </div>
            </div>
